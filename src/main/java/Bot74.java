...
public class Bot74 extends TelegramLongPollingBot {
    ...
    public Bot74() throws FileNotFoundException, UnirestException, URISyntaxException {
    ...
    public void onUpdateReceived(Update update) {
        ...
        if (!users.containsKey(chatId)) {
            ...
            if (users.get(chatId).getPhase() == 12){
                ...
                sendMessage.setText(
                        "welcome to devoe74bot tutorial."
