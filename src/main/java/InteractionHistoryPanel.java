        ...
        new Thread(() -> {
            ...
            while (true){
                ...
                if (lab1orLab2) {
                    ...
                    for (int i = 0; i < Bot74.lastUsers.size(); i++) {
                        this.labels[i] = new JLabel();
                        labels[i].setFont(font1);
                        labels[i].setBounds(10, (i+1) * 45, 600, 20);
                        this.labels[i].setText(
                                "user: " + Bot74.lastUsers.get(Bot74.lastUsers.size() - 1 - i) +
                                        ", activity: " + Bot74.lastMassages.get(Bot74.lastMassages.size() - 1 - i) +
                                        ", date: " + Bot74.lastDates.get(Bot74.lastDates.size() - 1 - i));
